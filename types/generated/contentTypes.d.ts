...
export interface ApiBarberoBarbero extends Struct.CollectionTypeSchema {
...
export interface ApiHorasTrabajoHorasTrabajo
  extends Struct.CollectionTypeSchema {
  collectionName: 'horas_trabajos';
  info: {
    description: '';
    displayName: 'horas_trabajo';
    pluralName: 'horas-trabajos';
